...
/**
 * Retrieves the last documents from mongo for the specified metric and
 * aggregation.
 * @param String aggr  minute|hour|day|week|month
 * @param String name  Metric name
 * @param Number num   Number of documents to retrieve
 * @param Function cb  Callback function
 */
Maggr.prototype.getLast = function(aggr, name, num, cb){
  this.db[aggr].find({
    n: name
  },
  {
